  ...
  private
    ...
    def user_params
      params.require(:user).permit(
        ...
        :show_sidebar, :default_period, :default_account_order, :show_ai_sidebar, :ai_sidebar_width, :ai_enabled, :theme, :set_onboarding_preferences_at, :set_onboarding_goals_at,
